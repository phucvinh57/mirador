...
int main(int argc, char const* argv[])
{
    ...
    [[maybe_unused]] auto config_file =
        ConfigFile{runner, runner.config_file(), ConfigFile::Mode::reload_on_change,
    ...
    return runner.run_with({X11Support{}, set_window_management_policy<WM>(stage_manager), launcher,
                            miral::AppendKeyboardEventFilter(keybinds),
                            miral::Decorations::prefer_csd(), miral::CursorScale{},
